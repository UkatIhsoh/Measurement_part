...
xst -ifn xst.scr
move DCM_100M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\DCM_100M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc DCM_100M_exdes.ucf DCM_100M_exdes

echo 'Running map'
map -timing -pr b DCM_100M_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm DCM_100M_exdes -w routed.ncd routed.vhd
cd ..
